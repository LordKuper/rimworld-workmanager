...
namespace LordKuper.WorkManager.Settings
{
    ...
    public class WorkTypeSettings : IExposable
    {
        ...
        private WorkTypePawnSettings _pawnSettings = new WorkTypePawnSettings();
        private WorkTypeDef _workTypeDef;
        public bool AllowDedicatedWorkers = true;
        public bool AssignToIdlePawns = true;
        public DedicatedMode DedicatedWorkersMode = DedicatedMode.WorkTypeCount;
        public bool EnsureDedicatedWorker = true;
        public PawnCountSettings PawnCountSettings = new PawnCountSettings();
        ...
        public WorkTypePawnSettings PawnSettings
        {
            get => _pawnSettings;
            set => _pawnSettings = value;
        }
        ...
        public string WorkTypeName
        {
            get
            {
                if (WorkTypeDefName == null)
                {
                    return Resources.Strings.Settings.WorkTypes.DefaultWorkTypeName;
                }
                if (!_isInitialized)
                {
                    Initialize();
        ...
        public void ExposeData()
        {
            ...
            Scribe_Deep.Look(ref _pawnSettings, nameof(PawnSettings));
